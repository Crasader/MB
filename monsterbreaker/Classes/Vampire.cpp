...
void Vampire::MoodAttack(float dt)
{
	if (timer == kTimerUp)
	{
		timer = AttackTime();
...
void Vampire::MoodStay(float dt)
{
	if (timer == kTimerUp)
	{
		timer = MoveTime();
...
void Vampire::MoodMove(float dt)
{
	if (timer == kTimerUp)
	{
		timer = MoveTime();
