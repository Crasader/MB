...
void BlackSmith::MoodAttack(float dt)
{
	if (timer == kTimerUp)
	{
		timer = AttackTime();
...
void BlackSmith::MoodMove(float dt)
{
	if (timer == kTimerUp)
	{
		timer = MoveTime();
...
//void BlackSmith::MoodStay(float dt)
//{
//	if (timer == kTimerUp)
//	{
//		timer = StayTime();
